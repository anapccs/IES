 ...
 */
	public function testGetContent() {
		...
		$this->assertRegExp('/Excluir Test View Model/', $result);
		$this->assertRegExp('/Edit Test View Model/', $result);
		$this->assertRegExp('/Listar Test View Models/', $result);
 ...
 */
	public function testBakeWithPlugin() {
		...
		$this->assertNotContains('Listar Test Test.view Task Articles', $result);
