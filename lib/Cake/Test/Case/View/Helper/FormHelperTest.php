 ...
 */
	public function testSecurePostButton() {
		...
		$result = $this->Form->postButton('Excluir', '/posts/delete/1');
		$expected = array(
			'form' => array(
 ...
 */
	public function testPostLink() {
		$result = $this->Form->postLink('Excluir', '/posts/delete/1');
		$this->assertTags($result, array(
			'form' => array(
		...
		$result = $this->Form->postLink('Excluir', '/posts/delete/1', array('method' => 'delete'));
		$this->assertTags($result, array(
			'form' => array(
				'method' => 'post', 'action' => '/posts/delete/1',
				'name' => 'preg:/post_\w+/', 'id' => 'preg:/post_\w+/', 'style' => 'display:none;'
		...
		$result = $this->Form->postLink('Excluir', '/posts/delete/1', array(), 'Confirm?');
		$this->assertTags($result, array(
			'form' => array(
				'method' => 'post', 'action' => '/posts/delete/1',
				'name' => 'preg:/post_\w+/', 'id' => 'preg:/post_\w+/', 'style' => 'display:none;'
		...
		$result = $this->Form->postLink('Excluir', '/posts/delete', array('data' => array('id' => 1)));
		$this->assertContains('<input type="hidden" name="data[id]" value="1"/>', $result);

		$result = $this->Form->postLink('Excluir', '/posts/delete/1', array('target' => '_blank'));
		$this->assertTags($result, array(
			'form' => array(
