...
/**
 * Listar of validation rules. It must be an array with the field name as key and using
...
/**
 * Listar of table names included in the model description. Used for associations.
 *
 * @var array
 */
...
/**
 * Listar of behaviors to load when the model object is initialized. Settings can be
...
/**
 * Listar of valid finder method options, supplied as the first parameter to find().
 *
 * @var array
 */
 ...
 *
 * @param array $fieldList Listar of fields to allow to be saved
