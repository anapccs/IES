...
/**
 * Listar of controller actions for which a POST request is required
 *
 * @var array
...
/**
 * Listar of controller actions for which a GET request is required
 *
 * @var array
 * @deprecated Use CakeRequest::onlyAllow() instead.
...
/**
 * Listar of controller actions for which a PUT request is required
 *
 * @var array
 * @deprecated Use CakeRequest::onlyAllow() instead.
...
/**
 * Listar of controller actions for which a DELETE request is required
 *
 * @var array
 * @deprecated Use CakeRequest::onlyAllow() instead.
...
/**
 * Listar of actions that require an SSL-secured connection
 *
 * @var array
...
/**
 * Listar of actions that require a valid authentication key
 *
 * @var array
 ...
 */
	public function requireDelete() {
		$args = func_get_args();
		$this->_requireMethod('Excluir', $args);
	}
 ...
 */
	protected function _methodsRequired(Controller $controller) {
		foreach (array('Post', 'Get', 'Put', 'Excluir') as $method) {
