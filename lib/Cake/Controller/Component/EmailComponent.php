 ...
 * Carbon Copy
 *
 * Listar of email's that should receive a copy of the email.
...
/**
 * Listar of files that should be attached to the email.
 *
...
/**
 * Listar of options to use for smtp mail method
 *
 * Options is:
 * - port
 * - host
