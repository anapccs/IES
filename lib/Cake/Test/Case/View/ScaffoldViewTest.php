 ...
 */
	public function testIndexScaffold() {
		...
		$this->assertRegExp('#<li><a href="/scaffold_users">Listar Scaffold Users</a></li>#', $result);
 ...
 */
	public function testViewScaffold() {
		...
		$this->assertRegExp('/<a href="\#" onclick="if[^>]*>Excluir Scaffold Mock<\/a>\s<\/li>/', $result);
		//check related table
 ...
 */
	public function testEditScaffold() {
		...
		$this->assertRegExp('/<a href="\#" onclick="if[^>]*>Excluir<\/a><\/li>/', $result);
	}
