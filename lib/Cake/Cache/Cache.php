 ...
 * - `groups` Listar of groups or 'tags' associated to every key stored in this config.
...
/**
 * Excluir all keys from the cache.
 *
...
/**
 * Excluir all keys from the cache belonging to the same group.
 *
