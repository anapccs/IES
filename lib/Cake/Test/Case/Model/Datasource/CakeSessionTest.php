 ...
 */
	public function testDelete() {
		$this->assertTrue(TestCakeSession::write('Excluir.me', 'Clearing out'));
		$this->assertTrue(TestCakeSession::delete('Excluir.me'));
		$this->assertFalse(TestCakeSession::check('Excluir.me'));
		$this->assertTrue(TestCakeSession::check('Excluir'));
